...
def upgrade() -> None:
    ...
    sa.Column('status', postgresql.ENUM('not_started', 'in_process', 'finished', name='matchstatus', create_type=False), nullable=False),
    sa.Column('team1_goals', sa.Integer(), nullable=True),
    sa.Column('team2_goals', sa.Integer(), nullable=True),
    sa.Column('start_time', sa.DateTime(timezone=True), nullable=True),
    sa.Column('event_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('fk_matches_event_id_events'), ondelete='CASCADE'),
